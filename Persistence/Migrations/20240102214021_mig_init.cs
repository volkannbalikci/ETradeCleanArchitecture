    ...
    public partial class mig_init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Adverts_IndividualUsers_IndividualUserId",
                        column: x => x.IndividualUserId,
                        principalTable: "IndividualUsers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CorporateUserAdverts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CorporateUserAdverts_Adverts_AdvertId",
                        column: x => x.AdvertId,
                        principalTable: "Adverts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CorporateUserAdverts_CorporateUsers_CorporateUserId",
            ...
            migrationBuilder.CreateTable(
                name: "IndividualUserAdverts",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IndividulaUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AdvertId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IndividualUserAdverts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IndividualUserAdverts_Adverts_AdvertId",
                        column: x => x.AdvertId,
                        principalTable: "Adverts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_IndividualUserAdverts_IndividualUsers_IndividualUserId",
                        column: x => x.IndividualUserId,
                        principalTable: "IndividualUsers",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Adverts_IndividualUserId",
                table: "Adverts",
                column: "IndividualUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CorporateUserAdverts_AdvertId",
                table: "CorporateUserAdverts",
                column: "AdvertId");

            migrationBuilder.CreateIndex(
                name: "IX_CorporateUserAdverts_CorporateUserId",
                table: "CorporateUserAdverts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IndividualUserAdverts_AdvertId",
                table: "IndividualUserAdverts",
                column: "AdvertId");

            migrationBuilder.CreateIndex(
                name: "IX_IndividualUserAdverts_IndividualUserId",
                table: "IndividualUserAdverts",
                column: "IndividualUserId");
